    ...
    public class CarCAD
    {
        ...
        public CarEN getCar(int code)
        {
            try
            {
                ...
                car = new CarEN((int)dr[0], (int)dr[1], dr[2].ToString(), dr[3].ToString(), Double.Parse(dr[4].ToString()), Boolean.Parse(dr[5].ToString()), Int32.Parse(dr[6].ToString()), dr[7].ToString());
                return (car);
